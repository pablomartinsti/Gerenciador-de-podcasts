...
export const getFilterCategory = async (req: IncomingMessage, res: ServerResponse) => {
  const content: PodcastTransferModel = await serviceFilterCategory(req.url);

  res.writeHead(content.statuCode, {
